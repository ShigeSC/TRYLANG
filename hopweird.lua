...
local SCRIPT_URL = "https://raw.githubusercontent.com/ShigeSC/TRYLANG/refs/heads/main/hopweird.lua"
...
local function updateStatusUI()
    ...
    SpentLabel.Text = formatSheckles(totalSpent)
    ...
    if petProtectEnabled then
        ...
        petProtectThread = task.spawn(function()
            ...
            local function securePet(pet)
                ...
                local shecklesBefore = getSheckles()
                ...
                while petProtectEnabled do
                    ...
                    if not pet.Parent then
                        ...
                        for _ = 1, 12 do
                            if countOwnedPet(expectedPetName) > ownedBefore then
                                acquired = true
                                break
                            end
                            task.wait(0.05)
                    ...
                    if purchaseRequested and shecklesBefore then
                        local currentSheckles = getSheckles()
                        if currentSheckles and currentSheckles < shecklesBefore then
                            claimedWildPets[pet] = true
                            recordSecuredPet(pet, expectedPetName, purchasePrice, purchaseRequested)
                            aimAtNextWildPet()
                            break
                    ...
                    if intruder and intruder.Character then
                        ...
                        if prompt and prompt.Enabled then
                            ...
                            if not price or price < maxPetPrice then
                                if price and not purchaseRequested then
                                    purchasePrice = price
